...
export const updateProfile = asyncHandler(async (req: AuthRequest, res: Response) => {
  const allowedUser = ['name', 'mobile', 'profileImage', 'gender', 'age', 'city'];
  const allowedTrainer = ['fullName', 'mobile', 'profilePhoto', 'bio', 'resume', 'experience', 'certifications', 'achievements', 'pricing', 'categories', 'category', 'languages', 'city', 'availability', 'sessionTypes', 'specializations', 'exactLocation', 'isExactLocationShared'];
