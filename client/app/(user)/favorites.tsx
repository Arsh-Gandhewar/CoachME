...
const styles = StyleSheet.create({
  ...
  browseBtn: { backgroundColor: '#0A0A0A', borderWidth: 1, borderColor: '#B388FF', paddingHorizontal: 24, paddingVertical: 12, borderRadius: 24 },
  browseText: { color: '#B388FF', fontSize: 12, fontWeight: '600' },
