...
export default function TrainerDetailScreen() {
  ...
  if (loading) return <View style={styles.loading}><ActivityIndicator size="large" color="#B388FF" /></View>;
  ...
  const colors = ['#B388FF', '#7C4DFF', '#00BCD4', '#4CAF50', '#E91E63'];
...
const styles = StyleSheet.create({
  ...
  stats: { flexDirection: 'row', justifyContent: 'space-around', backgroundColor: '#0A0A0A', marginHorizontal: 16, borderRadius: 16, padding: 12, marginTop: -24, borderWidth: 1, borderColor: 'rgba(255,255,255,0.04)' },
  ...
  showMore: { color: '#B388FF', fontSize: 12, marginTop: 6, fontWeight: '500' },
  ...
  bookPrice: { color: '#B388FF', fontSize: 16, fontWeight: '800' },
  ...
  bookBtn: { backgroundColor: '#B388FF', paddingHorizontal: 24, paddingVertical: 14, borderRadius: 14 },
