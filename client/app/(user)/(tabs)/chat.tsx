...
const styles = StyleSheet.create({
  ...
  chatItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1a1a1a', borderRadius: 16, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)' },
  avatar: { width: 48, height: 48, borderRadius: 14, backgroundColor: '#242424', justifyContent: 'center', alignItems: 'center' },
  avatarText: { fontSize: 20 },
  chatInfo: { flex: 1, marginLeft: 12 },
  chatName: { color: '#fff', fontSize: 15, fontWeight: '600' },
  lastMsg: { color: '#9E9E9E', fontSize: 13, marginTop: 2 },
  time: { color: '#666', fontSize: 11 },
  emptyState: { alignItems: 'center', marginTop: 80 },
  emptyIcon: { fontSize: 48, marginBottom: 12 },
  emptyTitle: { color: '#fff', fontSize: 18, fontWeight: '600' },
  emptyDesc: { color: '#666', fontSize: 13, marginTop: 4, textAlign: 'center' },
});
