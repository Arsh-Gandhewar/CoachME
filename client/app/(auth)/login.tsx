...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 14, color: '#9E9E9E', marginTop: 8, textAlign: 'center' },
  form: { backgroundColor: '#1a1a1a', borderRadius: 20, padding: 24, borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)' },
  title: { fontSize: 24, fontWeight: '700', color: '#fff', marginBottom: 4 },
  desc: { fontSize: 14, color: '#9E9E9E', marginBottom: 24 },
  ...
  input: { backgroundColor: '#242424', borderRadius: 12, padding: 14, fontSize: 15, color: '#fff', borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)' },
  passwordContainer: { flexDirection: 'row', alignItems: 'center', position: 'relative' },
  eyeBtn: { position: 'absolute', right: 14, top: 14 },
  eyeText: { color: '#FF5722', fontSize: 13, fontWeight: '600' },
  forgot: { color: '#FF5722', fontSize: 13, textAlign: 'right', marginBottom: 20, fontWeight: '500' },
  btn: { backgroundColor: '#FF5722', borderRadius: 14, padding: 16, alignItems: 'center', ...Platform.select({ web: { cursor: 'pointer' as any }, default: {} }) },
  btnDisabled: { opacity: 0.6 },
  btnText: { color: '#fff', fontSize: 16, fontWeight: '700' },
  footer: { flexDirection: 'row', justifyContent: 'center', marginTop: 20 },
  footerText: { color: '#9E9E9E', fontSize: 14 },
  link: { color: '#FF5722', fontSize: 14, fontWeight: '600' },
  testCreds: { color: '#616161', fontSize: 11, textAlign: 'center', marginTop: 20 },
});
