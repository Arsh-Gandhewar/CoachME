...
const styles = StyleSheet.create({
  ...
  eyeText: { color: '#9D00FF', fontSize: 12, fontWeight: '600' },
  forgot: { color: '#9D00FF', fontSize: 12, textAlign: 'right', marginBottom: 20, fontWeight: '500' },
  btn: { backgroundColor: '#9D00FF', borderRadius: 14, padding: 16, alignItems: 'center', ...Platform.select({ web: { cursor: 'pointer' as any }, default: {} }) },
