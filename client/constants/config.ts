export const API_BASE_URL = process.env.EXPO_PUBLIC_API_URL || 'http://10.210.116.209:5000/api';
export const SOCKET_URL = process.env.EXPO_PUBLIC_SOCKET_URL || 'http://10.210.116.209:5000';
